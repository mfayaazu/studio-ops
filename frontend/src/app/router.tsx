...
export type AppRoute = 'dashboard' | 'clients' | 'projects' | 'employees' | 'events' | 'availability' | 'backups' | 'deliverables' | 'follow-up-center' | 'post-production' | 'quotations' | 'message-templates' | 'forgot-password' | 'reset-password' | 'accept-invite' | 'my-account' | 'platform-admin';
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const validRoutes: AppRoute[] = [
        ...
        'forgot-password', 'reset-password', 'accept-invite', 'my-account', 'platform-admin'
      ];
