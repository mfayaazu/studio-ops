...
public class MessageTemplateCreateRequest {
    ...
    public MessageTemplateCreateRequest() {
    }

    public MessageTemplateCreateRequest(UUID studioId, String name, CommunicationChannel channel, MessageTemplateType templateType, String subject, String body, Boolean active) {
